...
from compare_models_speed.ATLAS_models.lib.SegNet.segnet import segnet
...
def run(model_path, img_count):
    ...
    ## create model
    model = segnet(n_classes=2, in_channels=1).cuda()
...
if __name__ == '__main__':
    ...
    start = time.time()
    start_2 = datetime.datetime.now()
    model_path = "C:/Users/user/Documents/python-code/11_c_paper/compare_models_speed/ATLAS_models/models/SegNet_in2d_out2d"
    model_path = os.path.join(model_path, "c_PSPNet_by_id_best_model.pkl")
    # a = 1
    # for i in range(1000):
...
#
# C:\Users\user\.conda\envs\open-mmlab\python.exe C:/Users/user/Documents/python-code/11_c_paper/compare_models_speed/SegNet_in2d_out2d.py
# 2021-10-21 23:11:44,374-<run>-[line:91]-INFO: Let the games begin
# 2021-10-21 23:11:44,374-<run>-[line:92]-INFO: ========================================
# 2021-10-21 23:11:44,374-<run>-[line:93]-INFO: # parameters:
# 2021-10-21 23:11:44,374-<run>-[line:94]-INFO: IMG_H=224
# 2021-10-21 23:11:44,375-<run>-[line:95]-INFO: IMG_W=224
# 2021-10-21 23:11:44,375-<run>-[line:96]-INFO: img_depth=1
# 2021-10-21 23:11:44,375-<run>-[line:97]-INFO: img_depth_out_num=2
# 2021-10-21 23:11:44,375-<run>-[line:98]-INFO: batch_size=16
# 2021-10-21 23:11:44,375-<run>-[line:99]-INFO: n_classes=2
# 2021-10-21 23:11:44,375-<run>-[line:100]-INFO: learning_rate=0.001
# 2021-10-21 23:11:44,375-<run>-[line:101]-INFO: patience_scheduler=5
# 2021-10-21 23:11:44,375-<run>-[line:102]-INFO: patience_early_stop=10
# 2021-10-21 23:11:44,375-<run>-[line:103]-INFO: ReduceLR_factor=0.2
# 2021-10-21 23:11:44,375-<run>-[line:105]-INFO: ========================================
# ==========================================
# Device: cuda
# Current cuda device: 0
# torch.cuda.device_count()= 1
# ==========================================
# 2021-10-21 23:11:44,527-<run>-[line:132]-INFO: ----------------------------------------- load train (33453): C:/Users/user/Documents/python-code/11_c_paper/data/ATLAS/by_id/train/imgs/
# Parameters: 29443014
# Parameters: 29443014
# predict 100 imgs : 5.176815748214722
# predict 100 imgs : 0:00:05.176816
# predict FPS is      : 19.316893794121615/s
# ------------------------------------------------
# predict 1,000 imgs : 6.603780508041382
# predict 1,000 imgs : 0:00:06.603780
# predict FPS is      : 151.4284126769971/s
# ------------------------------------------------
# predict 10,000 imgs : 41.66422390937805
# predict 10,000 imgs : 0:00:41.664224
# predict FPS is      : 240.01407110691758/s
# ------------------------------------------------
# predict 30,000 imgs : 123.66010546684265
# predict 30,000 imgs : 0:02:03.660106
# predict FPS is      : 242.60047237339603/s
# ------------------------------------------------
# all:178.82331681251526
# all:0:02:58.823317
#
