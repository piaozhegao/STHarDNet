...
from compare_models_speed.ATLAS_models.lib.pspnet_model.pspnet import PSPNet
...
if __name__ == '__main__':
    ...
    start = time.time()
    start_2 = datetime.datetime.now()
    model_path = "C:/Users/user/Documents/python-code/11_c_paper/compare_models_speed/ATLAS_models/models/PSPNet_in2d_out2d"
