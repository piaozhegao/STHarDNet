...
from compare_models_speed.ATLAS_models.lib.DUnet_parts import *
...
class DUnet(nn.Module):
    def __init__(self, in_channels, weights_init=True):
        ...
        self.conv_10 = nn.Sequential(
            nn.Conv2d(in_channels * 8, 2, kernel_size=1, padding=0),
            nn.Sigmoid()
            #nn.Softmax()
        )
...
if __name__ == "__main__":
    ...
    print("input: {}".format(input_batch.size()))
